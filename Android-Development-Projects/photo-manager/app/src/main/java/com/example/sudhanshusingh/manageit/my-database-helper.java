...
public class MyDatabaseHelper extends SQLiteOpenHelper {
  ...
  public static final String[] ALL_COLUMNS = {
      ID, TAG_NAME, CATEGORY_NAME, IMAGE_NAME, IMAGE_FILE, IMAGE_CREATED};
  ...
  static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " ( " + ID
      + " INTEGER PRIMARY KEY AUTOINCREMENT, " + TAG_NAME + " VARCHAR, " + CATEGORY_NAME
      + " VARCHAR, " + IMAGE_NAME + " VARCHAR, " + IMAGE_FILE + " VARCHAR, " + IMAGE_CREATED
      + " TEXT default CURRENT_TIMESTAMP "
      + " ) ";

  static final String CREATE_CATEGORY_TABLE = "CREATE TABLE " + CATEGORY_TABLE_NAME + " ( "
      + CATEGORY_NAME + " VARCHAR PRIMARY KEY, " + TAG_COUNT + " INTEGER, " + IMAGE_COUNT
      + " INTEGER "
      + " ) ";
