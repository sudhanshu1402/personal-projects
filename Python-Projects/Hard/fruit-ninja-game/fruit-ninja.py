...
lives_icon = pygame.image.load(
    "images/white_lives.png"
...
def generate_random_fruits(fruit):
    ...
    data[fruit] = {
        ...
        "speed_y": random.randint(
            -80, -60
        ),  # control the speed of fruits in y-directionn ( UP )
...
def draw_lives(display, x, y, lives, image):
    for i in range(lives):
        ...
        img_rect.x = int(
            x + 35 * i
        )  # sets the next cross icon 35pixels awt from the previous one
