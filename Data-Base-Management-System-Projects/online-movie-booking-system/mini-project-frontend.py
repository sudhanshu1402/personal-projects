...
class Movie:
    def __init__(self, root):
        ...
        self.txtMovie_ID = Entry(
            DFrameL,
            font=("Arial", 18, "bold"),
            textvariable=Movie_ID,
            width=39,
            bg="black",
            fg="white",
        )
        ...
        self.txtMovie_Name = Entry(
            DFrameL,
            font=("Arial", 18, "bold"),
            textvariable=Movie_Name,
            width=39,
            bg="black",
            fg="white",
        )
        ...
        self.txtRelease_Date = Entry(
            DFrameL,
            font=("Arial", 18, "bold"),
            textvariable=Release_Date,
            width=39,
            bg="black",
            fg="white",
        )
        ...
        self.txtDirector = Entry(
            DFrameL,
            font=("Arial", 18, "bold"),
            textvariable=Director,
            width=39,
            bg="black",
            fg="white",
        )
        ...
        self.lblBudget = Label(
            DFrameL,
            font=("Arial", 18, "bold"),
            text="Budget (Crores INR):",
            padx=2,
            pady=2,
            bg="black",
            fg="orange",
