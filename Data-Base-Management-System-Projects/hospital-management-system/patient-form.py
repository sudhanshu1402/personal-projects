...
class Patient:
    def __init__(self, master):
        ...
        self.lblAlt = Entry(
            ...
            font="Helvetica 14 bold",
            bd=2,
            textvariable=self.pat_contactalt,
        )
    ...
    def UPDATE_PAT(self):
        ...
        if len(p) != 0:
            ...
            conn.execute(
                "UPDATE CONTACT_NO set CONTACTNO=?,ALT_CONTACT=? WHERE PATIENT_ID=?",
                (
                    u6,
                    u7,
                    u1,
...
class DMenu:
    def __init__(self, master):
        ...
        self.del_pid = IntVar()
        self.lblTitle = Label(
            self.frame, text="DELETE WINDOW", font="Helvetica 20 bold", bg="cadet blue"
        )
        self.lblTitle.grid(row=0, column=0, columnspan=2, pady=50)
        # ==============FRAME==========
        self.LoginFrame = Frame(
        ...
        self.lblpatid = Label(
            self.LoginFrame,
            text="ENTER PATIENT ID TO DELETE",
            font="Helvetica 14 bold",
            bg="cadet blue",
            bd=22,
        )
...
class SMenu:
    def __init__(self, master):
        ...
        self.s_pid = IntVar()
        self.lblTitle = Label(
            self.frame, text="SEARCH WINDOW", font="Helvetica 20 bold", bg="cadet blue"
        )
    ...
    def SEARCH_PAT(self):
        ...
        if len(p) == 0:
            ...
            t = c1.execute(
                "SELECT * FROM PATIENT NATURAL JOIN CONTACT_NO where PATIENT_ID=?",
                (inp_s,),
            )
            for i in t:
                self.l1 = Label(
