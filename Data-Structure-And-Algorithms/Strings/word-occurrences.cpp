...
loop through your string until you find a character that matches the first
character in your word; create a substring using the current index and the
length of the word you are looking for; increment your counter if the 2 strings
are identical. Here we will need to use a new function called __substr()__.
Simply, this function creates a substring from a string using __2 arguments__,
start index and length of the new string.
