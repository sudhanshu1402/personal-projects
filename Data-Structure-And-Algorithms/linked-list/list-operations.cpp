...
class LinkedList {
 ...
 public:
  ...
  @_aj7t
    ...
    /****************
    we need to declare a temporary pointer temp in order to traverse through the
    list. temp is made to point the first node of the list.
    ...
    *************/
    ...
    /*FIXME:Check the Linked List is empty or not if empty make the new node as
     * head  else */
